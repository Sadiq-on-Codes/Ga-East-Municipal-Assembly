  ...
  <nav
    ...
    <div class="container flex flex-wrap items-center justify-between mx-auto">
      <a href="#" class="flex items-center">
        ...
        <span
          class="self-center text-xl font-logo-text font-bold whitespace-nowrap dark:text-white text-logo-color uppercase text-left">Ga
          East <br /> Municipal Assembly</span>
      </a>
      <div class="flex md:order-2">
        <router-link to="/documents">
          <button type="button"
            class="text-white font-semibold bg-button-bg focus:ring-4 focus:outline-none focus:ring-blue-300 text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 hover:bg-button-bg-hover">
            Documents
          </button>
        </router-link>
      ...
      <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
        <ul
          class="flex nav flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
          <router-link to="/">
            <li>
              <a href="#"
