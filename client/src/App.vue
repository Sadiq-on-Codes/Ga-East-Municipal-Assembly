...
router.beforeEach((to, from, next) => {
  ...
  if (to.path === "/admin/dashboard" || to.path === "/admin/new-post" || to.path === "/admin/view-posts"|| to.name === "EditPost" || to.path === "/admin/view-posts" || to.path === "/admin/add-document" || to.path === "/admin/view-documents" || to.path === "/admin/add-slider" || to.path === "/admin/view-sliders") {
