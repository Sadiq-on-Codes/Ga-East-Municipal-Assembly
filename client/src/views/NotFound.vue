...
<div class="w-full h-screen flex flex-col items-center justify-center">
    <div class="flex flex-col items-center justify-center">
        <img class='w-20 mb-10 h-auto' src="../assets/logo-transparent.png" alt="">
        ...
        <button @click="navigate" class="flex items-center space-x-2 bg-button-bg hover:bg-button-bg-hover text-gray-100 px-4 py-2 mt-12 rounded transition duration-150" title="Return Home">
